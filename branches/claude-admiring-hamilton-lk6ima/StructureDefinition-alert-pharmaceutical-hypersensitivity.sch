...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'nonATCSubstanceComment']) &lt;= 1">extension with URL = 'nonATCSubstanceComment': maximum cardinality of 'extension' is 1</sch:assert>
