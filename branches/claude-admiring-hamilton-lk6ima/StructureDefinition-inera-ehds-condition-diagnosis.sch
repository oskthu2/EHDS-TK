...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile ConditionUvIps
  ...
  <sch:pattern>
    <sch:title>f:Condition/f:category/f:coding/f:display</sch:title>
    <sch:rule context="f:Condition/f:category/f:coding/f:display">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality of 'value' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:Condition/f:category/f:text</sch:title>
    <sch:rule context="f:Condition/f:category/f:text">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality of 'value' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:Condition/f:code/f:coding/f:display</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Condition/f:code/f:text</sch:title>
