# TypeOfPrescription — ValueSet - Inera EHDS Tjänstekontrakt – FHIR Implementation Guide v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/ehds-tk/ValueSet/typeofprescription-vs | *Version*:0.1.0 |
| Active as of 2026-06-24 | *Computable Name*:TypeOfPrescriptionVS |
...
```json
{
  ...
  "url" : "https://fhir.inera.se/ig/ehds-tk/ValueSet/typeofprescription-vs",
  "version" : "0.1.0",
