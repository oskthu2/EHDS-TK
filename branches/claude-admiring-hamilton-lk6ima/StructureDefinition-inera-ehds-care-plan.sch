...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CarePlan">
      <sch:assert test="count(f:extension[@url = 'https://fhir.inera.se/ig/ehds-tk/StructureDefinition/approved-for-patient']) &lt;= 1">extension with URL = 'https://fhir.inera.se/ig/ehds-tk/StructureDefinition/approved-for-patient': maximum cardinality of 'extension' is 1</sch:assert>
