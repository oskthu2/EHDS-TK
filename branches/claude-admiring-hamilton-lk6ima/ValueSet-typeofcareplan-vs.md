# TypeOfCarePlan — ValueSet - Inera EHDS Tjänstekontrakt – FHIR Implementation Guide v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/ehds-tk/ValueSet/typeofcareplan-vs | *Version*:0.1.0 |
| Active as of 2026-06-24 | *Computable Name*:TypeOfCarePlanVS |
...
```json
{
  ...
  "url" : "https://fhir.inera.se/ig/ehds-tk/ValueSet/typeofcareplan-vs",
  "version" : "0.1.0",
