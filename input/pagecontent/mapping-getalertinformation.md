...
| `alertInformationHeader.legalAuthenticator.legalAuthenticatorHSAId` | 0..1 | `Flag.extension[asserter].identifier` | Via asserter-referens; ingår även i AllergyIntolerance.asserter om allergi |
...
| ALERT-003 | **Designbeslut: Flag skapas alltid.** Flag skapas för varje alertInformation-post oavsett typ. AllergyIntolerance skapas dessutom om typeOfAlertInformation anger allergi. `Flag.extension[allergyReference]` pekar på AllergyIntolerance. Beslutet är fattat (GENERAL-004, ALERT-003) och gäller. |
