...
Logical: IneraEHDSLMReferralOutcome
...
* referralOutcome.referralOutcomeHeader.patientId.system 1..1 uri "OID för typ av identifierare (t.ex. urn:oid:1.2.752.129.2.1.3.1)"
